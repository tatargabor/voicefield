        ...
        <div className="container">
          <div className="platforms">
            ...
            <div className="platforms-icons">
              ...
              <span className="platform-badge">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20.581 19.049c-.55-.446-.336-1.431-.907-1.917.553-3.365-.997-6.331-2.845-8.232-1.551-1.595-1.051-3.147-1.051-4.49 0-2.146-.881-4.41-3.55-4.41-2.853 0-3.635 2.38-3.663 3.738-.068 3.262.659 4.11-1.25 6.484-2.246 2.793-2.577 5.579-2.07 7.057a.18.18 0 00.164.108l.14-.012c1.18-.164 1.742-.472 2.629-.472 1.362 0 2.563 0 3.278-.373.715-.373.959-1.119 1.065-1.543.106-.424.159-.53.477-.53.159 0 .477.212.901.636.424.424.636.848.848 1.325.212.477.742.583 1.166.583h2.125a1.588 1.588 0 001.166-.53c.318-.318.53-.742.636-1.166.106-.424.053-.795-.259-1.06z"/><path d="M12.014 4.674c.849 0 1.537.688 1.537 1.537s-.688 1.537-1.537 1.537-1.537-.688-1.537-1.537.688-1.537 1.537-1.537z"/></svg>
                Linux
              </span>
              ...
              <span className="platform-badge">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M17.523 15.341c-.018 0-.037-.009-.055-.009H6.532c-.018 0-.036.009-.054.009-.021 0-.042-.009-.063-.009A3.415 3.415 0 003 18.747 3.415 3.415 0 006.415 22.16c.021 0 .042-.008.063-.008.018 0 .036.008.054.008h10.936c.018 0 .037-.008.055-.008.022 0 .044.008.065.008a3.415 3.415 0 003.412-3.414 3.415 3.415 0 00-3.412-3.414c-.021 0-.043.009-.065.009zM6.38 20.525a1.77 1.77 0 01-1.768-1.77 1.77 1.77 0 011.769-1.77 1.77 1.77 0 011.769 1.77 1.77 1.77 0 01-1.77 1.77zm11.24 0a1.77 1.77 0 01-1.769-1.77 1.77 1.77 0 011.77-1.77 1.77 1.77 0 011.768 1.77 1.77 1.77 0 01-1.77 1.77zM3.859 7.006A2.006 2.006 0 001.853 9.01v3.013a2.006 2.006 0 002.006 2.006h1.004a2.006 2.006 0 002.006-2.006V9.01a2.006 2.006 0 00-2.006-2.005H3.859zM20.141 7.006a2.006 2.006 0 00-2.006 2.005v3.013a2.006 2.006 0 002.006 2.006h1.004a2.006 2.006 0 002.006-2.006V9.01a2.006 2.006 0 00-2.006-2.005h-1.004zM15.1 2.311l1.028-1.869a.214.214 0 00-.084-.292.216.216 0 00-.294.084l-1.042 1.893A7.267 7.267 0 0012 1.692c-.97 0-1.9.153-2.708.435L8.25.234a.216.216 0 00-.294-.084.214.214 0 00-.084.292l1.028 1.869C7.009 3.208 5.751 5.041 5.751 7.16h12.498c0-2.119-1.258-3.952-3.149-4.849zM9.229 5.476a.64.64 0 01-.643-.639.64.64 0 01.643-.639.64.64 0 01.644.639.64.64 0 01-.644.639zm5.542 0a.64.64 0 01-.644-.639.64.64 0 01.644-.639.64.64 0 01.643.639.64.64 0 01-.643.639zM5.751 14.144v.998c0 1.109.903 2.006 2.006 2.006h1.004v2.508a2.006 2.006 0 002.006 2.006 2.006 2.006 0 002.006-2.006v-2.508h.454v2.508a2.006 2.006 0 002.006 2.006 2.006 2.006 0 002.006-2.006v-2.508h1.004a2.006 2.006 0 002.006-2.006v-.998H5.751z"/></svg>
                Android
              </span>
            </div>
          </div>
